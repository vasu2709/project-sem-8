...
const CategoryHoverHeading = ({ children }: Props) => {
  return (
    <div className="flex gap-1 text-lg mb-4 relative">
      ...
      <label className="pl-5">{children}</label>
    </div>
  )
}

export default CategoryHoverHeading
