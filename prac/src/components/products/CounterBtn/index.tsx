...
const CounterBtn = ({
  ...
  return (
    <>
      <div className="flex gap-2 sm:gap-4 items-center border-b-2 border-greenDark-50 w-max rounded-none overflow-hidden shadow-lg shadow-green/20 mt-4">
        <button
          color="green"
          id="countdecrease"
        ...
        <button
          ...
          className={clsx(
            [
              "border-l disabled:opacity-20 disabled:cursor-not-allowed hover:text-greenDark-50 duration-300",
              className,
            ],
            {
              "px-2": size === "md",
